...
export const CurrentMealApiActions = createActionGroup({
  ...
  events: {
    ...
    'Update Meal Entry Successful': emptyProps(),
    'Update Meal Entry Failed': props<{ error: unknown }>(),
    'Delete Meal Entry Successful': emptyProps(),
    'Delete Meal Entry Failed': props<{ error: unknown }>(),
